...
export default function EditRegistrarManagement() {
   ...
   * @returns The function `isViewValid` returns a boolean value. It returns `true` if all the input
   * fields (last name, first name, email, department, and contact number) are not empty and the email
   * address is valid. It returns `false` if any of the input fields are empty or the email address is
   * invalid.
   */
  const isViewValid = () => {
  ...
  /**
   * The function `postRegistrar` updates a registrar's information in a database if the input data is
   * valid.
   */
  const postRegistrar = () => {
    if (isViewValid()) {
      ...
      <div className="form__container">
        <div className="form__wrapper">
          <div className="form__bottom">
            <div className="form__bottom__content">{t("last_name")}</div>
            <input
              placeholder=""
              value={lastName}
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("first_name")}</div>
            <input
              placeholder=""
              value={firstName}
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("department")}</div>
            <input
              placeholder=""
              value={department}
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("off_contct_no")}</div>
            <input
              placeholder=""
              value={contactNumber}
