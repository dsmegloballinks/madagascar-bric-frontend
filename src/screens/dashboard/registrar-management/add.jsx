    ...
    <div className={hoverStyle}>
      ...
      <div className="form__container">
        <div className="form__wrapper">
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("appt_address")}</div>
            <input
              placeholder=""
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("appt_status")}</div>
            <InputSelect
              placeholder="Select"
              widthProp={"1030px"}
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("appt_date")}</div>
            <input
              placeholder=""
              type="date"
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("appt_time")}</div>
            <input
              placeholder=""
              type="time"
          ...
          <div className="form__bottom">
            <div className="form__bottom__content">{t("appt_by")}</div>
            <input
              placeholder=""
              value={appointedBy}
